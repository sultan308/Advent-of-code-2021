 ...
 * if the current index value is less than the previous index value it adds one to the counter
 * returns counter
*/
 ...
 * keeps the previous value
 * if the current index total is less than the total it adds one to the counter
 * returns counter
*/
